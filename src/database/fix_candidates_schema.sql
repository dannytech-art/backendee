...
-- Use USING clause to ensure proper type conversion
ALTER TABLE candidates 
ALTER COLUMN image TYPE VARCHAR(2000) USING image::VARCHAR(2000);

ALTER TABLE candidates 
ALTER COLUMN name TYPE VARCHAR(500) USING name::VARCHAR(500);

ALTER TABLE candidates 
ALTER COLUMN party TYPE VARCHAR(500) USING party::VARCHAR(500);
...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE candidates ALTER COLUMN bio TYPE TEXT USING bio::TEXT;
    END IF;
END $$;
