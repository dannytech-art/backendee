-- Fix comments table - WORKING VERSION
-- This handles the case where news_id column already exists
-- Copy and paste this ENTIRE block into Supabase SQL Editor

-- Step 1: Make election_id nullable (MOST IMPORTANT!)
ALTER TABLE comments ALTER COLUMN election_id DROP NOT NULL;

-- Step 2: Add news_id column only if it doesn't exist (safe to run multiple times)
DO $$ 
BEGIN
    IF NOT EXISTS (
